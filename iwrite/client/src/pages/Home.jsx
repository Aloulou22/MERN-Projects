            ...
            <div className="my-5">
                ...
                <div className="row">
                    {status === "success" && stories.map((story) => (
                        <div key={story._id} className="col-md-6 col-lg-4 text-center text-decoration-none">
                        ...
                        <Link to={`/story/${story._id}`}><button className="btn btn-primary text-white lead fw-bold mb-5">Read Story</button></Link>
                    </div>
