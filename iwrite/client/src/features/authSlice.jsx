...
export const register = createAsyncThunk("/auth/register", async (params, { dispatch , rejectWithValue }) => {
    try {
...
export const login = createAsyncThunk("/auth/login", async (params, { dispatch, rejectWithValue }) => {
    try {
